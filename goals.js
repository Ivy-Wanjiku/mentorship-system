const todoForm = document.getElementsById('main-goals');
const todoInput = document.getElementsByClassName('goals-input');
const todoList = document.getElementByIdClassName('goals-list');
